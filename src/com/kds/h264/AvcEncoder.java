...
@SuppressLint("NewApi")
public class AvcEncoder 	//²ÉÓÃavcÓ²¼þ±àÂë
{
...
//	    MediaFormat mediaFormat = MediaFormat.createVideoFormat("video/3gpp", width, height);
	...
	public void GetCodecInfo() {
		...
		for (int i = 0; i < numCodecs; i++) {
			...
			Log.e("decoderName", codecInfo.getName());
			String[] types = codecInfo.getSupportedTypes();
			for (int j = 0; j < types.length; j++) {
					Log.e("decoderType", types[j]);
			}
		}
	}
}
