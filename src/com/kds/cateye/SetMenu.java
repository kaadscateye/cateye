...
public class SetMenu extends Activity implements OnClickListener{
    ...
    private void InitUImenu() {
		...
		LinearLayout Set_Menu_wifi = (LinearLayout)findViewById(R.id.linear_Set_Menu_wifi_Id);//更改wifi网络
		LinearLayout camera_Set = (LinearLayout)findViewById(R.id.linear_Set_Menu_camera_Set_Id);//摄像头设置
		LinearLayout Set_Menu_Scan_QR_Code = (LinearLayout)findViewById(R.id.linear_Set_Menu_Scan_QR_Code_Id);//二维码扫描
		LinearLayout Set_Menu_set_bell = (LinearLayout)findViewById(R.id.linear_Set_Menu_set_bell_Id);//门铃设置
		LinearLayout Set_Menu_power_set_menu = (LinearLayout)findViewById(R.id.linear_Set_Menu_power_set_menu_Id);//节能模式设置
		LinearLayout Set_Menu_system_time = (LinearLayout)findViewById(R.id.linear_Set_Menu_system_time_Id);//时间日期
		LinearLayout Set_Menu_language = (LinearLayout)findViewById(R.id.linear_Set_Menu_language_Id);//语言		
		LinearLayout Set_Menu_Display = (LinearLayout)findViewById(R.id.linear_Set_Menu_Display_Id);//显示
		LinearLayout Set_Menu_storage = (LinearLayout)findViewById(R.id.linear_Set_Menu_storage_Id);//存储
		LinearLayout Set_Menu_Factory_reset = (LinearLayout)findViewById(R.id.linear_Set_Menu_Factory_reset_Id);//恢复出厂设置
		LinearLayout Set_Menu_Software_version = (LinearLayout)findViewById(R.id.linear_Set_Menu_Software_version_Id);//软件版本
	...
	public void onClick(View arg0) {
		...
		case R.id.linear_Set_Menu_power_set_menu_Id:
			break;
		case R.id.Set_Menu_system_time_Id:
			break;
		case R.id.linear_Set_Menu_language_Id:
			break;
		case R.id.linear_Set_Menu_Display_Id:	
			startActivity(new Intent().setClass(getApplicationContext(), DisplayMenu.class));
			break;
		case R.id.linear_Set_Menu_storage_Id:
			startActivity(new Intent().setClass(getApplicationContext(), ExternalStorage.class));
			break;	
		case R.id.linear_Set_Menu_Factory_reset_Id:
			FactoryFromat();
			break;
		case R.id.linear_Set_Menu_Software_version_Id:
			break;
